...
- Deltas: {'volume_db': 0.0, 'bass_gain_db': -2.24, 'presence_gain_db': 0.0, 'treble_gain_db': -0.52}
- Genre (local ML, gradient_boosting): `chill_ambient` (74% confidence)
- Explanation: "Because of a noisy environment during music, I pulled bass back 2.2 dB, warmed treble by 0.5 dB. Sounds like chill/ambient (74% confidence, local gradient_boosting model), so I leaned the curve that way."
